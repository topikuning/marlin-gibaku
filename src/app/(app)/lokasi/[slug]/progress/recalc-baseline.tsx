 ...
 *
 * Konfirmasi + hasil ditampilkan sebagai popover absolute (mengambang di atas
 * layout) supaya tidak mendorong / menumpuk kartu tetangga di header. DECISIONS:
 * tombol selalu ada di tempatnya; panel muncul di bawah-kanan tombol.
 */
