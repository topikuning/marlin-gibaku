                  ...
                  {documents.map((d) => (
                    <tr key={d.id}>
                      <td className="py-1.5 pr-3">
                        <Link href={`/dokumen-laporan/dokumen/${d.id}`} className="font-medium text-primary hover:underline">
