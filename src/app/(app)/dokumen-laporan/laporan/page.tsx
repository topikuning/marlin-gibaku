  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <AntreanLink
          href="/dokumen-laporan/laporan/perlu-koreksi"
          label="Perlu koreksi"
          count={perluKoreksi}
        ...
        />
        <AntreanLink
          href="/dokumen-laporan/laporan/menunggu-verifikasi"
              ...
              <ul className="divide-y divide-border text-sm">
                {locations.map((l) => (
                  <li key={l.id} className="flex items-center justify-between gap-2 py-2">
                    ...
                    <Link href={`/proyek/lokasi/${l.slug}/laporan-lokasi`} className="font-medium text-primary hover:underline">
                      Buka laporan
                    </Link>
                  </li>
                ))}
              ...
              <ul className="divide-y divide-border text-sm">
                {recentFinal.map((r) => (
                  <li key={r.id} className="flex items-center justify-between gap-2 py-2">
                    ...
                    <Link
                      href={withBackTo(`/cetak/harian/${r.location.slug}/${jakartaDateKey(r.reportDate)}`, "/dokumen-laporan/laporan")}
