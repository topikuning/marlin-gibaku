 ...
 * `/proyek/lokasi/a/progress` memilih B berarti `/proyek/lokasi/b/progress`, bukan
 * `/proyek/lokasi/b`. Termasuk tanggal pada `/harian/[date]`: tanggalnya milik
...
export function LocationSwitcher({
  ...
  function hrefFor(slug: string): string {
    ...
    // ["", "lokasi", "<slug>", ...sisa]
    if (parts[1] !== "lokasi" || parts.length < 3) return `/proyek/lokasi/${slug}`;
    parts[2] = slug;
    return parts.join("/");
  }
