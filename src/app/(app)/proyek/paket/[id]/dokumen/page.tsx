...
import { MilestonePanel, SyncComplianceButton } from "@/app/(app)/proyek/lokasi/[slug]/dokumen/kepatuhan-client";
    ...
    <div className="space-y-6">
      ...
      {canUpload ? (
        <Card>
          ...
          <CardBody>
            <Link
              href={`/dokumen-laporan/dokumen/impor?paket=${pkg.id}`}
      ...
      <Card>
        <CardHeader
          ...
          action={
            <Link href="/dokumen-laporan/dokumen" className="text-[13px] font-medium text-primary hover:underline">
                    ...
                    {byPhase.get(phase)!.map((doc) => (
                      ...
                      >
                        <div className="min-w-0">
                          <Link
                            href={`/dokumen-laporan/dokumen/${doc.id}`}
