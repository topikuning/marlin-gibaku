  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <KpiCard label="Total paket" value={stats.total} href="/proyek/paket" />
        <KpiCard label="Dalam tender" value={stats.tender} href="/proyek/paket?stage=tender" />
        <KpiCard label="Berkontrak" value={stats.berkontrak} href="/proyek/paket?stage=berkontrak" />
        <KpiCard
      ...
      {filter ? (
        <Banner
          ...
          description={
            <Link href="/proyek/paket" className="font-medium text-primary hover:underline">
              Hapus filter
            </Link>
          }
        />
