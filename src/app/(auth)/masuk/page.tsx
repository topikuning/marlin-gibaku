...
export default async function MasukPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-5 py-12">
      {/* aksen navy KNMP di latar */}
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-blue-50 via-slate-50 to-slate-50" />
      ...
      <div className="relative w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-2xl border-b-4 border-[#d21f2a] bg-[#1e3a8a] text-2xl font-bold text-white shadow-lg shadow-blue-900/20">
            M
          </div>
