...
<header>
  <h1>${esc(r.title)}</h1>
  <p class="meta">Periode ${o.periodStart} s/d ${o.periodEnd} · data per ${esc(o.dataAsOf.slice(0, 16).replace("T", " "))} UTC · status: <strong>${STATUS_LABEL[r.overallStatus]}</strong> · confidence AI ${r.confidence}%</p>
</header>
