...
const WORKTYPE_BY_CATEGORY: ReadonlyArray<readonly [WorkType, readonly string[]]> = [
  ...
  // Infrastruktur non-bangunan (tanpa kata bangunan). Catatan: TPS/tempat sampah
  // = struktur pasangan kecil → dibiarkan jatuh ke gedung (bukan utilitas).
  ["utilitas", ["PLUMBING", "PENERANGAN", "IPAL", "SUMUR BOR", "SUMUR", "TANGKI", "AIR BERSIH", "ELEKTRIKAL", "MEKANIKAL", "HIDRAN", "DISTRIBUSI"]],
...
/** Kata kunci fixture MEP akhir (dipasang setelah cat) + peralatan aktif (pompa). */
const KW_MEP_FINISH = ["LAMPU", "ARMATUR", "DOWNLIGHT", "SAKLAR", "SAKELAR", "STOP KONTAK", "STOPKONTAK", "FITTING", "PJU", "PENERANGAN", "EXHAUST", "AC SPLIT", "AC ", "KIPAS", "FAN", "POMPA", "SUBMERSIBLE", "DEEPWELL", "DEEP WELL", "ELEKTRODA", "WATER LEVEL", "LEVEL SWITCH", "PRESSURE", "BLOWER"];
const KW_SANITAIR = ["KLOSET", "CLOSET", "WASTAFEL", "URINOIR", "URINAL", "KRAN", "KERAN", "JET WASHER", "FLOOR DRAIN", "SHOWER", "WATER HEATER", "SANITAIR", "SANITARY", "TANDON", "TOREN", "SEPTIKTANK", "SEPTICTANK", "SEPTIK", "SEPTIC", "BIO TECH", "BIO-TECH", "BIOTECH", "IPAL", "TANGKI AIR", "TANGKI", "RESERVOIR", "FRP", "TEMPAT SAMPAH", "BAK SAMPAH"];
const KW_MEP_ROUGHIN = ["KABEL", "KONDUIT", "CONDUIT", "INSTALASI", "PIPA", "SPARING", "GROUNDING", "ARDE", "PANEL", "MCB", "BOX PANEL", "TRAY KABEL", "PVC", "WIRING", "STEKER", "KABEL TRAY", "GRUNDING", "VALVE", "FLANGE", "GATE VALVE", "HIDRAN", "HYDRANT", "ACCESSORIES", "TRAFO", "KWH", "SIRKULASI", "WATER CIRCULATION"];
const KW_TESTING = ["TESTING", "COMMISSIONING", "SLO", "NIDI", "PENDAFTARAN", "UJI ", "PENGUJIAN", "SERTIFIKAT LAIK"];

// Gedung — struktur & arsitektur. Persiapan mencakup ALAT BERAT, daya listrik
// site, dan survei/penyelidikan (semuanya di awal proyek).
const KW_PERSIAPAN = ["BEDENG", "DIREKSI", "PAPAN NAMA", "MOBILISASI", "DEMOBILISASI", "K3", "APD", "SAFETY", "HELM", "ROMPI", "SARUNG TANGAN", "SEPATU", "MASKER", "P3K", "APAR", "RAMBU", "INDUKSI", "SOSIALISASI", "IJIN KERJA", "IZIN KERJA", "KIP", "BPJS", "ASURANSI", "PEMBERSIHAN", "LAND CLEARING", "CLEARING", "PEMBONGKARAN", "BONGKARAN", "BOUWPLANK", "UITZET", "PENGUKURAN", "SEWA RUMAH", "LISTRIK KERJA", "AIR KERJA", "PAGAR SEMENTARA", "SETTING OUT", "PLANK", "BULLDOZER", "EXCAVATOR", "ROLLER VIBRATOR", "VIBRATOR ROLLER", "DUMP TRUCK", "CONCRETE MIXER", "MIXER PUMP", "MESIN LAS", "STAKE OUT", "STAKEOUT", "STAKING", "STAKE-OUT", "PANEL DISTRIBUSI KAWASAN", "LVMDP", "PDTR", "PASANG BARU DAYA", "GEOLISTRIK", "PENYELIDIKAN", "SONDIR", "CUTTING BOR", "GEOLOGI", "GEOTEKNIK", "GEOLISTRIC", "PENGIRIMAN", "PERAKITAN", "PENGADAAN BARANG", "KOMPRESOR", "JETTING"];
...
const KW_PONDASI = ["PONDASI", "FOOTPLAT", "FOOT PLAT", "TAPAK", "STROUS", "BORE PILE", "BOR PILE", "ANSTAMPING", "AANSTAMPING", "BATU KOSONG", "BATU KALI", "ROLLAG", "ROLAAG", "SLOOF", "LANTAI KERJA", "LEAN CONCRETE", "SUMURAN", "PENGEBORAN", "BOR DALAM", "TIANG BOR", "GRAVEL PACK", "GRAVEL"];
const KW_STRUKTUR = ["KOLOM", "BALOK", "RING BALK", "RINGBALK", "PELAT", "PLAT LANTAI", "PEMBESIAN", "BEKESTING", "BEKISTING", "BETON", "READYMIX", "READY MIX", "WIREMESH", "WIRE MESH", "BESI BETON", "ANGKUR", "ANGKER", "ANCHOR", "DYNABOLT", "PRECAST", "BONDEK", "COR ", "COR BETON", "LANGSIR COR", "LANGSIR", "K-225", "K-250", "K-300", "FC ", "F'C", "STEK", "BESI SIKU", "RANGKA SIKU", "PLAT BORDES", "BORDES", "GRATING", "GRATTING", "PERANCAH", "SCAFFOLDING", "STEGER", "SETTING BESI", "PLAT BESI", "PLAT BAJA", "BAJA WF", "DOWEL", "TULANGAN", "TUL.", "DUDUKAN", "ROD COUPLING", "COUPLING", "PENGECORAN"];
...
const KW_FINISHING = ["KERAMIK", "GRANIT", "GRANITE", "PAVING", "KUSEN", "PINTU", "JENDELA", "CASEMENT", "KACA", "PENGECATAN", "CAT ", "CAT LUAR", "DUCO", "WATERPROOF", "WATER PROOF", "RAILING", "HANDLE", "KUNCI", "SCREED", "PLESTERAN", "PLESTER", "ACIAN", "ACI ", "PROFIL", "HURUF TIMBUL", "PLINT", "WALLPAPER", "HANDRAIL", "GROUTING NAT", "LANTAI KERAMIK", "LANTAI GRANIT", "SKONENGAN", "FLOOR HARDENER", "HARDENER", "SEALER", "WEATHER SHIELD", "PAGAR BRC", "PAGAR", "BRC", "DOOR CLOSER"];
const KW_LANSEKAP = ["PENANAMAN", "TANAMAN", "RUMPUT", "POHON", "TAMAN", "LANDSKAP", "LANSEKAP", "GAZEBO", "PAVING TAMAN"];

// Jalan.
const KW_BADAN_JALAN = ["SUBGRADE", "BADAN JALAN", "GALIAN", "TIMBUNAN", "URUGAN", "URUG", "PEMADATAN", "CLEARING", "TANAH DASAR", "SIRTU", "PEMBENTUKAN"];
const KW_DRAINASE = ["DRAINASE", "SALURAN", "GORONG", "GORONG-GORONG", "U-DITCH", "UDITCH", "BOX CULVERT", "PIPA DRAINASE", "PIPA", "SUMUR RESAPAN", "BAK KONTROL", "GRATING", "GRATTING", "STEEL GRATTING", "TUTUP BAK"];
const KW_LAPIS_PONDASI = ["AGREGAT", "LAPIS PONDASI", "LPA", "LPB", "BASE COURSE", "SUB BASE", "SUBBASE", "MACADAM", "MAKADAM", "TELFORD", "SIRTU PADAT"];
const KW_PERKERASAN = ["ASPAL", "HOTMIX", "AC-WC", "AC-BC", "AC-BASE", "ACWC", "ACBC", "PRIME COAT", "TACK COAT", "LASTON", "PENETRASI", "RIGID", "PERKERASAN BETON", "RABAT BETON", "PAVING BLOCK", "PAVING", "BETON", "SITE MIX", "COR ", "COR BETON", "PEMBESIAN", "WIREMESH", "WIRE MESH", "DOWEL", "TULANGAN", "TUL.", "BESI BETON", "PLASTIK COR", "PERANCAH", "MPA"];
const KW_PELENGKAP_JALAN = ["KANSTIN", "KANSTEEN", "KERB", "BAHU JALAN", "TROTOAR", "KANSTINE", "CANSTEEN", "CANSTIN", "ACIAN"];
const KW_MARKA = ["MARKA", "RAMBU", "GUARDRAIL", "GUARD RAIL", "PAKU JALAN", "ZEBRA", "RPPJ", "TRAFFIC"];

// Marine. Sub = galian/pancang/perancah (akses); struktur = beton/bekisting/
// pembesian/armour; deck = lantai atas + finishing (acian/cat/hardener).
const KW_MARINE_SUB = ["PANCANG", "TIANG PANCANG", "GEOTEXTILE", "GEOTEKSTIL", "DREDGING", "PENGERUKAN", "GALIAN", "URUGAN", "URUG", "TIMBUNAN", "PEMADATAN", "SIRTU", "MAKADAM", "TAMPER", "FILTER", "CERUCUK", "PERANCAH", "SCAFFOLDING", "JALAN KERJA", "STAKE OUT"];
const KW_MARINE_STRUKTUR = ["ARMOUR", "ARMOR", "BRONJONG", "BATU", "POER", "POCK", "BALOK", "KOLOM", "PILECAP", "PILE CAP", "REVETMENT", "PASANGAN BATU", "BETON", "BEKESTING", "BEKISTING", "PEMBESIAN", "PELAT", "PLAT", "WIREMESH", "WIRE MESH", "DYNABOLT", "ANGKUR", "COR ", "LANGSIR", "TANGGA", "SLOOF", "DUDUKAN", "BESI BETON", "PONDASI"];
const KW_MARINE_DECK = ["DECK", "LANTAI", "CAPPING", "FENDER", "BOLLARD", "BOULDER", "PLENGSENGAN ATAS", "TRESTLE", "ACIAN", "PLESTERAN", "PLESTER", "CAT ", "FLOOR HARDENER", "HARDENER", "SEALER", "SKONENGAN", "WEATHER SHIELD", "KANSTIN"];

// Utilitas — mencakup struktur menara/tangki (pembesian/beton/dinding).
const KW_UTIL_GALIAN = ["GALIAN", "SUMUR BOR", "BOR", "PONDASI", "TANGKI", "TOWER", "MENARA", "TIANG", "PENGEBORAN"];
const KW_UTIL_PASANG = ["PIPA", "KABEL", "PANEL", "POMPA", "INSTALASI", "VALVE", "FLANGE", "GATE VALVE", "ACCESSORIES", "BIOTECH", "SEPTIC", "RENTENG", "TRAFO", "MCB", "KWH", "PEMBESIAN", "BEKESTING", "BEKISTING", "BETON", "COR ", "WIREMESH", "KOLOM", "BALOK", "PLAT", "DYNABOLT", "ANGKUR", "PERANCAH", "DINDING", "BATA", "PASANGAN", "ACIAN", "PLESTERAN", "SKONENGAN", "HURUF TIMBUL", "BESI BETON", "PENGECORAN"];
...
export function classifyStage(workType: WorkType, itemName: string, categoryName = ""): StageKey {
  ...
  if (workType === "umum") {
    // Kategori "PERSIAPAN/UMUM" selokasi → default awal (persiapan) kecuali tanah.
