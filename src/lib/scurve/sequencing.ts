...
const KW_PERSIAPAN = ["BEDENG", "DIREKSI", "PAPAN NAMA", "MOBILISASI", "DEMOBILISASI", "K3", "APD", "SAFETY", "HELM", "ROMPI", "SARUNG TANGAN", "SEPATU", "MASKER", "P3K", "APAR", "RAMBU", "INDUKSI", "SOSIALISASI", "IJIN KERJA", "IZIN KERJA", "KIP", "BPJS", "ASURANSI", "PEMBERSIHAN", "LAND CLEARING", "CLEARING", "PEMBONGKARAN", "BONGKARAN", "BOUWPLANK", "UITZET", "PENGUKURAN", "SEWA RUMAH", "LISTRIK KERJA", "AIR KERJA", "PAGAR SEMENTARA", "SETTING OUT", "PLANK"];
