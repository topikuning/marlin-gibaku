...
// ─────────────────────────────────────────────────────────────
// Rapikan teks (usulan → dicentang → ditulis balik ke kotak isian)
//
// Ketetapan user 2026-09-05: perapian bahasa BUKAN bagian dari finalisasi dan
// bukan bagian dari form buat; tempatnya di form EDIT kegiatan yang sudah
// tersimpan. Karena itu jalur lama yang merapikan-lalu-memfinalkan
// (`suggestActivityRewriteAction` + `finalizeActivityWithTextAction`, DECISIONS
// 179) dibuang, bukan sekadar disembunyikan dari layar: server action yang
// tidak dipakai layar mana pun tetap bisa dipanggil dari luar.
// ─────────────────────────────────────────────────────────────
