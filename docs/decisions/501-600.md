...
**Konsekuensi**: deck 16:9-nya belum ada – `renderLaporanLokasiDeck` melempar
`DeckBelumTersediaError` dan route menjawab 503 dengan pesan itu, bukan PDF
kosong yang mengaku deck. Tercatat di OPEN_ISSUES.
